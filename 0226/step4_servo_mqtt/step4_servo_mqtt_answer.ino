/******************************************************************************
 * step4_servo_mqtt_answer.ino
 * 4단계 해설 코드: 서보모터 제어 - MQTT 명령 수신 (Subscribe)
 *
...
// ===== MQTT 설정 =====
const char *MQTT_ID = "servo_01";               // 학생마다 고유하게 변경
const char *TOPIC   = "device/01/servo/cmd";    // 01을 본인 번호로 변경
