...
const char *ssid =  "hanoi_2.4G";   // name of your WiFi network
const char *password =  "sangho1028"; // password of the WiFi network
...
IPAddress broker(192,168,124,110); // IP address of your MQTT broker eg. 192.168.1.50
WiFiClient wclient;
